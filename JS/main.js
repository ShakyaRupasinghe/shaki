...
let swiperTestimonial = new Swiper(".testimonial__container", {
  ...
  var swiperAchievement = new Swiper(".achievements__container", {
...
document.addEventListener("DOMContentLoaded", function() {
  const professions = ["Computer Engineer", "Frontend Developer", "Project Manager","UX/UI designer"];
  let currentIndex = 0;

  function updateProfession() {
      document.getElementById("professionSlider").textContent = professions[currentIndex];
